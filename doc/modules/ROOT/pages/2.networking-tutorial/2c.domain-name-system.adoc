...
TXT:: A free-form text record. Often used for domain verification, email authentication schemes such as SPF (Sender Policy Framework) and DKIM (DomainKeys Identified Mail), and other administrative purposes.
