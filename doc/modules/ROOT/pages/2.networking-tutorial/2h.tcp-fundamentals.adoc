...
The sequence and acknowledgment numbers are the core of TCP's reliability. By tracking which bytes it sent and which the peer acknowledged, TCP can detect gaps (lost packets) and fill them with retransmissions.
