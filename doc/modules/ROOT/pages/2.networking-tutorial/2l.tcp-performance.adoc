...
On a transoceanic link at 10 Gbps with a 100-millisecond RTT, the BDP is 125 megabytes. A 64 KB window would use about 0.05% of the available bandwidth. Without the window scale extension, such a link would be unusable for a single TCP connection.
