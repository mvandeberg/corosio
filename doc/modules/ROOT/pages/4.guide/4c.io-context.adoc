...
* xref:4c2.configuration.adoc[Configuration] — tuning inline budget
  and event buffer size
* xref:4c3.latency-characteristics.adoc[Latency Characteristics] —
  understanding the p50/p99 trade-off and when to spread across
