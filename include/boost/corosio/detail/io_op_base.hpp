...
#ifndef BOOST_COROSIO_DETAIL_IO_OP_BASE_HPP
#define BOOST_COROSIO_DETAIL_IO_OP_BASE_HPP
...
class io_bytes_op_base
{
    friend Derived;
    io_bytes_op_base() = default;
...
*/
template<class Derived>
class io_void_op_base
{
    friend Derived;
    io_void_op_base() = default;
...
#endif // BOOST_COROSIO_DETAIL_IO_OP_BASE_HPP
