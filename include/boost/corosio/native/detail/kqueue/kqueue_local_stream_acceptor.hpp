...
#ifndef BOOST_COROSIO_NATIVE_DETAIL_KQUEUE_KQUEUE_LOCAL_STREAM_ACCEPTOR_HPP
#define BOOST_COROSIO_NATIVE_DETAIL_KQUEUE_KQUEUE_LOCAL_STREAM_ACCEPTOR_HPP
...
/// Acceptor implementation for local stream sockets on kqueue.
class kqueue_local_stream_acceptor final
    : public reactor_acceptor<
          ...
          kqueue_local_stream_op,
          kqueue_local_accept_op,
          descriptor_state,
          local_stream_acceptor::implementation,
          local_endpoint>
{
    friend class kqueue_local_stream_acceptor_service;
...
#endif // BOOST_COROSIO_NATIVE_DETAIL_KQUEUE_KQUEUE_LOCAL_STREAM_ACCEPTOR_HPP
