...
#ifndef BOOST_COROSIO_NATIVE_DETAIL_URING_URING_STREAM_FILE_HPP
#define BOOST_COROSIO_NATIVE_DETAIL_URING_URING_STREAM_FILE_HPP
...
/** Native io_uring stream-file service.
    ...
    Owns all `uring_stream_file` impls. Replaces
    `posix_stream_file_service` for the io_uring backend; registered
    under the abstract `file_service` key by `uring_t::construct`.
*/
...
#endif // BOOST_COROSIO_NATIVE_DETAIL_URING_URING_STREAM_FILE_HPP
